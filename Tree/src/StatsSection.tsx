...
export default function StatsSection() {
  ...
  const stats = [
    { value: 500, suffix: 'K+', label: 'Workflows Executed Daily' },
    { value: 99.8, decimals: 1, suffix: '%', label: 'Data Delivery Success Rate' },
    { value: 50, suffix: '+', label: 'Native Cloud Connectors' },
    { value: 15, suffix: '+', label: 'Core Protocol Integrations' },
    { value: 24, suffix: '/7', label: 'Automated Active Monitoring' },
  ];

  return (
    <section
      id="stats"
      className="bg-[#4f795a] text-white py-8 md:py-24 px-6 md:px-12 lg:px-[120px] w-full border-t border-white/10 overflow-hidden"
    >
      <div className="w-full max-w-[1440px] mx-auto">
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-[160px] items-stretch">
          ...
          >
            <h2 className="text-[clamp(1.5rem,4vw,3.5rem)] font-medium tracking-tight mb-6 leading-[1.1] w-[590px] max-w-full text-white">
              <Typewriter text="Powering Workflows" delay={0} speed={0.012} />
              <br />
              <Typewriter text="that " delay={0.25} speed={0.012} />
              <span className="font-dm-serif italic font-normal text-[#bce3c5]">
                <Typewriter text="Maximize Your Efficiency" delay={0.35} speed={0.012} />
              </span>
            </h2>

            <p className="text-base md:text-lg text-[#dbebdf] leading-relaxed font-normal max-w-lg whitespace-normal mb-16">
              <Typewriter
                text="For over a decade, the industry's most demanding enterprise operations have relied on our modern integration workflows and automated pipelines to process their data signals efficiently and eliminate latency."
                delay={0.1}
                speed={0.012}
              />
            </p>
            ...
            >
              {stats.map((stat, index) => (
                ...
                >
                  <span className="text-4xl md:text-5xl lg:text-[56px] font-dm-serif tracking-tight mb-3 text-white">
                    <AnimatedCounter
                      value={stat.value}
                      suffix={stat.suffix}
                  ...
                  <span className="text-[10px] md:text-xs font-semibold text-[#bce3c5] uppercase tracking-wider">
                    {stat.label}
                  </span>
                </motion.div>
              ))}
